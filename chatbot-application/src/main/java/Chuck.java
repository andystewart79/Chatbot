...
public class Chuck {
	...
	private static Phrases chuckPhrases() {
		return PhraseLoader.load("All arrays Chuck Norris declares are of infinite size, because Chuck Norris knows no bounds.",
